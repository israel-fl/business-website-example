...
<div id="about" class="container-fluid">
  <div class="row">
    <div class="col-sm-8">
      <h2>Welcome to a data-drive world</h2><br>
      <h4>
        Regardless of the industry, Data Science and Artificial Intelligence promise to reshape the way we do our jobs every day.
        At Data Rhino we seek to bring the power of data science and AI to our customers. Whether you want to explore the possible
        use cases for big data analytics or have an AI solution in mind and want to start quickly, our team of world-class data
        scientists and data engineers can help you achieve big data success and get the most out of your investment
      </h4><br>
...
<!-- Container (Contact Section) -->
<div id="googleMap" class="container-fluid bg-grey">
